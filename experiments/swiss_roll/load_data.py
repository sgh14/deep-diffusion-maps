...
def get_data(
    ...
    """
    Generate a colored Swiss Roll dataset and split it into training and test sets.
    
    This function creates a 3D Swiss Roll dataset using scikit-learn, assigns colors to
    ...
    dimension_1 = normalize(color)  # Normalized position along the spiral (0 to 1)
